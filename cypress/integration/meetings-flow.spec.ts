...
describe("Meetings Flow", () => {
  ...
  it("Creates Schedule from Meeting Modal", () => {
  ...
  it("Creates Meeting in Overview", () => {
    cy.visit(url(`/meetings`))
    ...
    cy.contains(meetingName).parent().parent().parent().contains("Copy Link")

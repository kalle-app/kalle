...
const Schedule = (props: ScheduleProps) => {
  ...
  const addSchedule = (e: React.ChangeEvent<HTMLInputElement>, day: string, type: string) => {
              ...
              <div className="grid grid-cols-8 gap-6 bg">
                <div className="col-span-2">
                  <DatePicker
                    ...
                    onChange={(date: Date) => props.onEdit("startDate", date)}
                    selectsStart
                  ...
                  <DatePicker
                    ...
                    onChange={(date: Date) => props.onEdit("endDate", date)}
                    selectsEnd
                    startDate={props.meeting.startDate}
                    endDate={props.meeting.endDate}
